...
<div class="wpcui_container">
	...
	<?php if (isset($_GET['template_message']) && $_GET['template_message'] == 'edited'): ?>
		<div class="notice notice-success is-dismissible"><p><?php _e('Template Updated Successfully',WPCUI_DOMAIN) ?></p></div>
	<?php elseif(isset($_GET['template_message']) && $_GET['template_message'] == 'notedited'): ?>
		<div class="notice notice-error is-dismissible"><p><?php _e('Template Update Failed',WPCUI_DOMAIN) ?></p></div>
	<?php elseif(isset($_GET['template_message']) && $_GET['template_message'] == 'added'): ?>
		<div class="notice notice-success is-dismissible"><p><?php _e('Template Added',WPCUI_DOMAIN) ?></p></div>
	<?php endif ?>
	...
	<form method="post" action="<?php echo admin_url('admin-post.php'); ?>" class="wpcui_custom_template_form">
		...
		<button class="button button-primary" type="submit"><?php _e('Save Settings',WPCUI_DOMAIN) ?></button>
